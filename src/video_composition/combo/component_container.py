...
class ComponentContainer:
    ...
    def add_component_container(self, component):
        self.video_components.extend(component.video_components)
        self.audio_components.extend(component.audio_components)
